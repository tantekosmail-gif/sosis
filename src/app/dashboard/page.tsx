    ...
    >
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center rounded-2xl border bg-white py-24 shadow-sm">
          ...
          <p className="mt-1 text-sm text-slate-400">
            Mengumpulkan dan memproses data dari platform
          </p>
        </div>
      )}
      ...
      {!loading && !dashboard && (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white py-28 text-center shadow-sm">
          ...
          <p className="mt-2 max-w-sm text-sm text-slate-400">
            Pilih platform dan masukkan keyword di atas, lalu klik{" "}
      ...
      {!loading && dashboard && (
        <>
          ...
          {/* Compare Panel (outside export area) */}
          <ComparePanel platform={platform} baseKeyword={dashboard.keyword ?? keyword} />
        </>
      )}
    </DashboardLayout>
  );
