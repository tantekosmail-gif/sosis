...
import TwitterSearchTab, { type TwitterSearchTabHandle } from "@/features/twitter/components/TwitterSearchTab";
...
export default function TwitterPage() {
  ...
  const searchRef = useRef<TwitterSearchTabHandle>(null);
          ...
          >
            <div className="flex flex-col gap-3 sm:flex-row">
              <div className="relative flex-1">
                ...
                <input
                  placeholder={t.twitterSearchTab.keywordPlaceholder}
                  value={query}
                  onChange={(e) => {
              ...
              >
                <Search size={15} />
                {t.twitterSearchTab.searchButton}
              </button>
            </div>
          </form>
        )}

        {tab === "terkini" && <TwitterSearchTab ref={searchRef} />}
        {tab === "trending" && <TwitterTrendingTab />}
        {tab === "sentiment" && <TwitterSentimentTab />}
      </div>
    </DashboardLayout>
  );
}
