...
import FacebookSearchTab, { type FacebookSearchTabHandle } from "@/features/facebook/components/FacebookSearchTab";
...
export default function FacebookPage() {
  ...
  const searchRef = useRef<FacebookSearchTabHandle>(null);
          ...
          >
            <div className="flex flex-col gap-3 sm:flex-row">
              <div className="relative flex-1">
                ...
                <input
                  placeholder={t.facebookSearchTab.keywordPlaceholder}
                  value={query}
                  onChange={(e) => {
              ...
              >
                <Search size={15} />
                {t.facebookSearchTab.searchButton}
              </button>
            </div>
          </form>
        )}

        {tab === "terkini" && <FacebookSearchTab ref={searchRef} />}
        {tab === "trending" && <FacebookTrendingTab />}
        {tab === "sentiment" && <FacebookSentimentTab />}
      </div>
    </DashboardLayout>
  );
}
