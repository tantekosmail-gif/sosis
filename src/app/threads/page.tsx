...
import ThreadsSearchTab, { type ThreadsSearchTabHandle } from "@/features/threads/components/ThreadsSearchTab";
...
export default function ThreadsPage() {
  ...
  const searchRef = useRef<ThreadsSearchTabHandle>(null);
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Threads</h1>
        </div>
        ...
        >
          <div className="flex flex-col gap-3 sm:flex-row">
            <div className="relative flex-1">
              ...
              <input
                placeholder={t.threadsSearchTab.keywordPlaceholder}
                value={query}
                onChange={(e) => {
        ...
        <ThreadsSearchTab ref={searchRef} />
      </div>
    </DashboardLayout>
  );
}
