...
import NewsSearchTab, { type NewsSearchTabHandle } from "@/features/news/components/NewsSearchTab";
...
const TABS = [
  { key: "terkini", label: "Analisis Berita" },
...
export default function NewsPage() {
  ...
  const searchRef = useRef<NewsSearchTabHandle>(null);
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        {tab === "terkini" && <NewsSearchTab ref={searchRef} />}
        {tab === "trending" && <NewsTrendingTab />}
      </div>
    </DashboardLayout>
  );
}
