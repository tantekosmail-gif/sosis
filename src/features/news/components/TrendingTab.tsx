...
export default function NewsTrendingTab() {
  ...
  return (
    <div className="space-y-6">
      {summaryLoading && (
        <div className="flex items-center justify-center rounded-2xl border bg-white py-12 shadow-sm">
      ...
      <div>
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-semibold text-slate-900">Artikel Trending Hari Ini</h2>
            {trending && (
        ...
        {trendingLoading && (
          <div className="flex flex-col items-center justify-center rounded-2xl border bg-white py-24 shadow-sm">
            ...
            <p className="font-semibold text-slate-700">Memuat artikel trending...</p>
          </div>
        )}
