    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Analisis sentimen komentar dari video sebuah akun TikTok
        </p>
      </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          <form onSubmit={handleSearch} className="flex-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="h-10 w-full rounded-xl border border-slate-200 bg-slate-50 pl-10 pr-4 text-sm text-slate-800 placeholder:text-slate-400 focus:border-rose-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-rose-500/20 transition"
              />
            </div>
          </form>
          ...
          <div className="shrink-0">
            ...
            <select
              ...
              className="h-10 rounded-xl border border-slate-200 bg-slate-50 px-3.5 text-sm text-slate-800 focus:border-rose-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-rose-500/20 transition"
            >
          ...
          {data && (
            <button
              ...
              disabled={loading}
              title="Ambil ulang data terbaru dari TikTok"
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center rounded-2xl border bg-white py-24 shadow-sm">
          ...
          <p className="font-semibold text-slate-700">Mengambil & menganalisis data TikTok...</p>
      ...
      {!loading && !error && !data && (
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white py-16 text-center text-sm text-slate-400">
          Masukkan username TikTok untuk melihat analisis sentimennya
        </div>
      )}
        ...
        <>
          {(data.scrape?.errors?.length ?? 0) > 0 && (
            <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm text-amber-800">
              ...
              <div>
                <p className="font-semibold">Gagal mengambil data terbaru dari TikTok</p>
