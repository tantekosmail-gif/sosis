  ...
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-100 dark:border-slate-800">
        <h2 className="font-semibold text-slate-900 dark:text-slate-100">Word Cloud</h2>
        <p className="mt-0.5 text-xs text-slate-400 dark:text-slate-500">50 kata yang paling sering muncul dalam komentar</p>
      </div>
