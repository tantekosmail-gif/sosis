...
import type { TikTokVideoMetadataDetail } from "@/features/tiktok/hooks/useVideoMetadataSearch";
import {
  Eye,
  ExternalLink,
  Flame,
...
const SCORE_ITEMS: { key: keyof TikTokVideoMetadataDetail["scores"]; icon: typeof Flame; labelKey: "trendScoreLabel" | "engagementScoreLabel" | "freshnessScoreLabel" | "authorityScoreLabel" }[] = [
...
interface Props {
  detail: TikTokVideoMetadataDetail | null;
  loading: boolean;
  error: string;
}

export default function VideoDetailPanel({ detail, loading, error }: Props) {
