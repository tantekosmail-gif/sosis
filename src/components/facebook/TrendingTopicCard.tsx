...
function getDominantSentiment(sentiment: FacebookTrendingTopic["sentiment"]) {
  ...
  return (
    <div
      className={`flex gap-3 rounded-xl border p-3 transition-colors ${
        isSelected ? "border-blue-400 bg-blue-50/40" : "border-transparent bg-slate-50 dark:bg-slate-950"
      }`}
    >
