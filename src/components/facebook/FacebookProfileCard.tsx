...
import { BadgeCheck, Grid3x3, MessageSquare, PieChart, TrendingUp } from "lucide-react";

import type { FacebookPageInfo, FacebookPostSentimentOverview, FacebookPostsStats } from "@/features/facebook/types/posts.types";
      ...
      {hasProfile ? (
        <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="min-w-0 flex-1">
            ...
            {pageInfo.category && <p className="mt-1.5 text-xs text-slate-500">{pageInfo.category}</p>}
          </div>
