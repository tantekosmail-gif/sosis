...
function SentimentBar({ summary }: { summary: FacebookPostSentimentBreakdown }) {
          ...
          >
            ...
            <div className="p-4">
              <a href={item.url} target="_blank" rel="noopener noreferrer" className="flex items-start gap-1">
                <p className="line-clamp-2 min-w-0 flex-1 break-words text-sm leading-snug text-slate-700 hover:text-blue-600 transition-colors">
