...
import type { FacebookMetadataDetail } from "@/features/facebook/hooks/useFacebookMetadataSearch";
import {
  Eye,
  ExternalLink,
  Flame,
...
const SCORE_ITEMS: { key: keyof FacebookMetadataDetail["scores"]; icon: typeof Flame; labelKey: string }[] = [
...
interface Props {
  detail: FacebookMetadataDetail | null;
  loading: boolean;
  error: string;
}
