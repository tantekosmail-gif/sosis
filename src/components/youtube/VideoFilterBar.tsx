...
export default function VideoFilterBar({
  ...
  /** Opsional — dilewatkan cuma di halaman yang tidak sudah punya kontrol
   *  periode server-side sendiri (mis. tab Terkini pakai "PERIODE"/hours_back,
   *  jadi filter umur client-side di sini jadi redundan & sebagian tidak
   *  pernah match karena window server-nya maks 1 minggu). */
  age?: VideoAgeFilter;
