  ...
  return (
    <div
      className={`flex gap-3 rounded-xl border p-3 transition-colors ${
        isSelected ? "border-indigo-400 bg-indigo-50/40" : "border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900"
      }`}
    >
      ...
      <div className="flex items-start justify-between gap-4 p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {topic.instagram_identifier && <p className="text-xs text-slate-400 dark:text-slate-500">Sumber: @{topic.instagram_identifier}</p>}
          </div>
        </div>
