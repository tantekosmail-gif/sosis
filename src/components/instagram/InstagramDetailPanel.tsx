...
import type { InstagramMetadataDetail } from "@/features/instagram/hooks/useInstagramMetadataSearch";
import {
  Eye,
  ExternalLink,
  Flame,
...
const SCORE_ITEMS: { key: keyof InstagramMetadataDetail["scores"]; icon: typeof Flame; labelKey: string }[] = [
...
interface Props {
  detail: InstagramMetadataDetail | null;
  loading: boolean;
  error: string;
}
